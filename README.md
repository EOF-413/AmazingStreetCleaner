...
[![Version](https://img.shields.io/badge/version-3.2.0-purple.svg)](https://github.com/EOF-413/AmazingStreetCleaner)
...
Этот репозиторий больше не поддерживается, используйте этот - https://github.com/EOF-413/AmazingStreetCleanerPlugin.
...
1. Скачайте установщик `ASC_Setup_X.Y.Z.exe`
